<template>
    <section>
        <div class="container section">
                    ...
                    <div class="modal-card">
                        ...
                        <section class="modal-card-body">
                            ...
                            <div class="field">
                                ...
                                <div class="control">
                                    <input class="input" type="text" placeholder="70.5" v-model="weight" v-bind:class="{'is-danger': missingWeight && attemptSubmit}">
                                </div>
                                <p v-show="attemptSubmit" class="help" v-bind:class="{'is-danger': missingWeight && attemptSubmit}">Input your weight.</p>
                            </div>
                        </section>
            ...
            <line-chart v-if="loaded" :chart-title="title" :chart-data="weights" :chart-labels="labels" :chart-category="selectedCategory" />
        </div>
    </section>
</template>
